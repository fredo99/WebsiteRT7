...
@section('content-dashboard')
  <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
      <div class="container mx-auto px-6 py-8">
        ...
        @endif
          <h3 class="text-gray-700 text-3xl font-medium">Album</h3>
          <div class="flex flex-col mt-8">
              <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                  <div
                      class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                      <button class="border bg-violet-500 hover:bg-violet-600 text-gray-800 text-lg hover:text-white mx-3 my-3 px-4 py-2 rounded-md" onclick="tambahalbum()">Tambah</button>
                      <table class="min-w-full display" id="tbl-album">
                          <thead>
                              <tr>
                                  <th
...
{{-- modal tambah album --}}
<dh-component>
    <form method="POST" action="/Admin/Album/create" enctype="multipart/form-data">
        @csrf
        <div class="py-12 bg-gray-200 bg-opacity-70 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0 hidden" id="modal-tambah-album">
            <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                <div class="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                    ...
                    <button class="cursor-pointer absolute top-0 right-0 mt-4 mr-5 text-gray-400 hover:text-gray-600 transition duration-150 ease-in-out rounded focus:ring-2 focus:outline-none focus:ring-gray-600" onclick="closemodalalbum()" aria-label="close modal" role="button">
